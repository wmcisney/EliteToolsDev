				...
				if (pd.colors) {
					settings = new[] {
						...
						new VtoPdfSettings() {
							...
							ImageUrl = "https://s3.amazonaws.com/Radial/base/Logos/TRACTION-TOOLS_Signature.png"//REPLACE_ME
						}, new VtoPdfSettings() {
							FillTextColor = Colors.Red,
							FillColor = Color.FromArgb(255, 118, 239, 34),
							ImageUrl = "https://s3.amazonaws.com/Radial/base/Charts/All.png"//REPLACE_ME
						}, new VtoPdfSettings() {
							FillColor = Color.FromArgb(255, 34, 118, 239),
							ImageUrl = "https://cataas.com/cat?height=150&width=100"//REPLACE_ME
						}
					};
				}
...
In addition to the marketing efforts, we are doing more targeted networking through the ALA and other organizations, as well as planning in person seminars for clients, and doing more client one-on-ones outside of the office to boost the personal relationships and encourage referrals.",
			...
			vto.ThreeYearPicture = new AngularThreeYearPicture() {
				...
				Headers = new List<AngularVtoKV> {
					new AngularVtoKV(){K= "Revenue",V = "$17M", },
					new AngularVtoKV(){K="Profit" ,V= "25% Net", },
					new AngularVtoKV(){K="Measurables ",V= "$ Revenue per Employee", }
				},
