...
namespace TractionTools.Tests.Permissions {
	...
	public class VtoPermissions : BasePermissionsTest {
		...
		public async Task ViewVto() {
			...
			c.AssertAll(p => p.ViewVTOVision(l10.VtoId), c.E2, c.Manager);
			c.AssertAll(p => p.ViewVTOTraction(l10.VtoId), c.E2, c.Manager);
			...
			c.AssertAll(p => p.ViewVTOVision(l10.VtoId), c.E2, c.Manager, c.E1);
			c.AssertAll(p => p.ViewVTOTraction(l10.VtoId), c.E2, c.Manager, c.E1);
		}
