...
//		public class MHSettings {
//			public bool ForceRefresh { get; set; }
//			public int RefreshId { get; set; }
//		}
//		protected static ServerSettings<MHSettings> Settings = new ServerSettings<MHSettings>(s => 
//			s.GetSettingOrDefault(Variable.Names.MEETING_HUB_SETTINGS,new MHSettings() {
//				ForceRefresh = true
//			})
//		);
...
//		public void Join(long meetingId=-100, string connectionId=null) {

//			if (Settings.Get().ForceRefresh) {
//				var hub = GlobalHost.ConnectionManager.GetHubContext<MeetingHub>();
//				var rth = hub.Clients.Client(Context.ConnectionId);
//				rth.showAlert(
//$@"Service updated. Refreshing. 
//<script>
//	if (typeof(Cookies.get(""LastForceRefresh{Settings.Get().RefreshId}""))=== ""undefined""){{ 
//		Cookies.set(""LastForceRefresh{Settings.Get().RefreshId}"", ""true"",{{ expires: 1 }})
//		setTimeout(function(){{
