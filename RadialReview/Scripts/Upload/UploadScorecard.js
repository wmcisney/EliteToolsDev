...
var uploader = new UploadSteps({
    defaultData: { recurrenceId: window.recurrenceId, type: "Scorecard", csv: true, noTitleBar: window.noTitleBar },
    ...
    afterUpload: function (d) {
        uploader.addSelectionStep("Select cells containing accountable users (Do not select header)", validateUsers);
        uploader.addSelectionStep("Select cells containing measurable titles (Do not select header)", validateMeasurables);
        uploader.addSelectionStep("Select cells containing goals (Do not select header)", validateGoal);
        uploader.addSelectionStep("Select cells containing dates (Start of week)", validateDate, true);
    }
});
