var logging = true;
if (logging) {
	$(window).on("wizard:first-page", function () { console.log("[Wizard] event: first-page"); });
	$(window).on("wizard:last-page", function () { console.log("[Wizard] event: last-page"); });
}
...
function changePage(page, first) {
    ...
    while (!doneLoading) {
        setTimeout(function () {
            ...
            console.log("[Wizard] Trying again to change page");
        }, 300);
        return;
    }
    var pages = $(".wizard-page:not(.hidden)");
    function showPage(pg) {
		console.log("[Wizard] Changing page");
        ...
        if (cpe.length == 0 && typeof (first) === "undefined") {
            ...
            cpe.fadeIn(function () {
                ...
                doneLoading = true;
				console.log("[Wizard] Changed page");
                currentPage = page;
