    ...
    */
	...
	function MGScale(args) {
		...
		this.numericalDomainFromData = function () {
			...
			if (illustrative_data && illustrative_data.length > 0) {
				isTimeSeries = mg_is_date(illustrative_data[0][args[scaleArgs.namespace_accessor_name]]);
			}

			scaleArgs.is_time_series = isTimeSeries ? true : false;
