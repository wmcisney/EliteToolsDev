...
namespace RadialReview.Controllers
{
    public class UnitTestController : BaseController
    {
		...
		[Access(AccessLevel.Radial)]
		public ActionResult IframeWebsockets() {
			return View();
		}

		[Access(AccessLevel.Radial)]
		public ActionResult SignalrCors() {
			return View();
		}
		...
		public ActionResult SelectExistingOrCreate(bool create=false) {
			...
			var obj = UserAccessor.BuildCreateUserVM(GetUser(), ViewBag, null);

			var settings = SelectExistingOrCreateUtility.Create<CreateUserOrganizationViewModel>("/User/Search", "CreateUserOrganizationViewModel","select","add","instructions",obj, create);
		...
		[Access(AccessLevel.Radial)]
		public ActionResult RealTimeEdge() {
			return View();
		}
		[Access(AccessLevel.Radial)]
		public ActionResult RealTimeEdgePart(bool start,bool join) {
			return View(Tuple.Create(start,join));
		}
