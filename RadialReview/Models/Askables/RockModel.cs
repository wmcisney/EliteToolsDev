...
namespace RadialReview.Models.Askables {
	public class RockModel :Askable/*, IAngularizer<RockModel>*/ {
		...
		public virtual bool _ToBeAddedToL10 { get; set; }
		...
		public class RockModelMap : SubclassMap<RockModel> {
			...
			/*	Join("UserOrganizationModel", x => {
					x.Fetch.Join();
					x.KeyColumn("ResponsibilityGroupModel_id");
					x.Map(y => y.EmailAtOrganization, "EmailAtOrganization");
				});*/
