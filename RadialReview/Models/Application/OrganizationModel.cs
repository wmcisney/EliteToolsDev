...
namespace RadialReview.Models {
	...
	public enum ShareVtoPages {
		[Display(Name = "Vision Only")]
		VisionOnly = 0,
		//[Display(Name = "Traction Only")]
		//TractionOnly = 1,
		[Display(Name = "Both Vision and Traction")]
		BothVisionAndTraction = 2,
		[Display(Name = "Both Vision and Traction excluding Issues")]
		BothVisionAndTractionNoIssues = 3,
	}

	public static class ShareVtoPagesExtension {
		public static bool ViewVision(this ShareVtoPages self) {
			switch (self) {
				case ShareVtoPages.BothVisionAndTractionNoIssues:
				case ShareVtoPages.BothVisionAndTraction:
				case ShareVtoPages.VisionOnly:
					return true;
				//case ShareVtoPages.TractionOnly:
				//	return false;
				default:
					return false;
			}
	...
	public class OrganizationModel : ResponsibilityGroupModel, IOrigin, IDeletable, TimeSettings {
		...
		public class OrganizationSettings : TimeSettings {
			...
			public OrganizationSettings() {
				...
				ShareVtoPages = ShareVtoPages.VisionOnly;
