	...
	public class AdminAccessViewModel {
		...
		private AdminAccessViewModel(long viewUserId, string setAsUserId) {
			...
			PotentialReasons = new List<SelectListItem>() {
				...
				new SelectListItem() {Text = "I need to update payment information", Value = "I need to update payment information" },
				new SelectListItem() {Text = "I need to update an account as requested by the client", Value = "I need to update an account as requested by the client" },
				//new SelectListItem() {Text = "ticket resolution", Value = "" },
				new SelectListItem() {Text = "I need to research login issues", Value = "I need to research login issues" },
				//new SelectListItem() {Text = "troubleshooting account", Value = "" },
