	...
	public partial class PdfAccessor {
		...
		public static async Task<QuarterlyPdfOutput> QuarterlyPrintout(UserOrganizationModel caller, long recurrenceId, bool issues, bool todos, bool scorecard, bool rocks, bool headlines, bool vto, bool l10, bool acc, bool print, bool quarterly, bool pa, int? maxSec) {
            ...
            if (vtoModel.ThreeYearPicture.FutureDate.HasValue && vtoModel.ThreeYearPicture.FutureDate.Value != vtoModel.ThreeYearPicture.FutureDate.Value.Date)
                vtoModel.ThreeYearPicture.FutureDate = vtoModel.ThreeYearPicture.FutureDate.Value.AddMinutes(caller.GetTimezoneOffset()).Date;
            if (vtoModel.OneYearPlan.FutureDate.HasValue && vtoModel.OneYearPlan.FutureDate.Value != vtoModel.OneYearPlan.FutureDate.Value.Date)
                vtoModel.OneYearPlan.FutureDate = vtoModel.OneYearPlan.FutureDate.Value.AddMinutes(caller.GetTimezoneOffset()).Date;
            if (vtoModel.QuarterlyRocks.FutureDate.HasValue && vtoModel.QuarterlyRocks.FutureDate.Value != vtoModel.QuarterlyRocks.FutureDate.Value.Date)
                vtoModel.QuarterlyRocks.FutureDate = vtoModel.QuarterlyRocks.FutureDate.Value.AddMinutes(caller.GetTimezoneOffset()).Date;
