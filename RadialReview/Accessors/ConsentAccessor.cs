			...
			using (var s = HibernateSession.GetCurrentSession()) {
				using (var tx = s.BeginTransaction()) {
					...
					var message = s.GetSettingOrDefault(Variable.Names.CONSENT_MESSAGE,
						...
						"<br/>We use this information for your login and to send you meeting summaries, to-dos, feature updates, best practices, and other information relevant to your use of Elite Tools (you can shut these off). " +
						"<br/>Elite Tools uses cookies to store your login. We need to collect your billing address. We log all IP addresses to protect the service from non-user actors. " +
						...
						"<br/><br/>Our service can't work without this data. So in order to use Elite Tools you must agree to us storing it." );
