...
namespace RadialReview.Areas.CoreProcess.Models {
    public class AmazonSQSUtility {
        ...
        private static string accessKey = "AKIAREPLACE_ME";
        private static string secretKey = "REPLACE_ME";
        //private string region = "us-west-2";
        private static string queueURL = "https://sqs.us-west-2.amazonaws.com/REPLACE_ME";
