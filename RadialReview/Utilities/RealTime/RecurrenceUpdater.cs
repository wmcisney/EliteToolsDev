...
namespace RadialReview.Utilities.RealTime {
    public partial class RealTimeUtility {
        public class RTRecurrenceUpdater {
            ...
            public RTRecurrenceUpdater UpdateScorecard(IEnumerable<ScoreModel> scores,DateTime? absoluteUpdateTime, AngularListType type = AngularListType.ReplaceIfNewer,long recurrenceId=0) {
                rt.AddAction(() => {
                    //UpdateAngular stuff
