...
namespace RadialReview.Utilities.Encrypt {
	public class EncryptionUtility {
		...
		//public static string ToEncrypted(string fileText, string decyptionPass) {
		//	var compressed = CompressionUtility.Compress(Encoding.UTF8.GetBytes(fileText));
		//	var encrypted = Encrypt(compressed, decyptionPass);
		//	return encrypted;
		//}
